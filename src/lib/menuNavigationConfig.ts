...
export const MENU_GRUPOS: NavGroupConfig[] = [
    ...
    colunas: [
      {
        ...
        itens: [
          ...
          {
            id: 'cad-setores',
            name: 'Setores de Mercado',
            path: '/planejamento/setores/cadastro',
            icon: Layers,
            descricao: 'Cadastro de setores, múltiplos de avaliação e benchmarks de mercado',
            modulo: 'planejamento',
            badge: 'Setores',
            badgeVariant: 'blue',
            palavrasChave: [
  ...
  // 7. Planejamento (Dropdown com BSC)
  {
    ...
    itens: [
      ...
      {
        id: 'plan-cadastro-setores',
        name: 'Cadastro de Setores',
        path: '/planejamento/setores/cadastro',
        icon: Layers,
        descricao: 'Gerenciar catálogo de setores, múltiplos de mercado e faixas financeiras',
        modulo: 'planejamento',
        palavrasChave: ['setores', 'cadastro setores', 'mercado', 'setor', 'múltiplos'],
      },
    ],
  },
